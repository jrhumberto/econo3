"""
Parte 1: Cria estrutura de pastas e gera app.py
"""
import os
...
def create_directory_structure():
    os.makedirs('econometric_system', exist_ok=True)
    print("[OK] Pasta econometric_system criada")
...
if __name__ == "__main__":
    main()
'''
    write_file('econometric_system/app.py', content)


def run_generate1():
    print("=== PARTE 1: Criando pasta e app.py ===")
