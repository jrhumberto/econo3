"""
Parte 2: Gera auth.py e models.py
"""
...
'''
    write_file('econometric_system/auth.py', content)
...
def run_random_forest(df: pd.DataFrame, y_var: str, x_vars: list, n_estimators: int, test_size: float) -> dict:
    try:
        ...
        return None
'''
    write_file('econometric_system/models.py', content)


def run_generate2():
    print("=== PARTE 2: Gerando auth.py e models.py ===")
    generate_auth_py()
    generate_models_py()
